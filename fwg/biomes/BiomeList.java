...
public class BiomeList 
{
	...
	public static void init()
	{
		...
		default_2 = new BiomeDefault(ConfigFWG.biomeIDs[0], 1).setBiomeName("fwg_default2");
		default_snow = new BiomeDefaultSnow(ConfigFWG.biomeIDs[0]).setBiomeName("fwg_default_snow").setTemperatureRainfall(0.0F, 0.5F);
