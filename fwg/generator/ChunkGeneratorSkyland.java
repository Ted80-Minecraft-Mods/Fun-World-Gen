...
import fwg.deco.DecoBigTree;
import fwg.deco.DecoDungeons;
import fwg.deco.DecoGold1;
...
public class ChunkGeneratorSkyland implements IChunkProvider
{
    private Random rand;
    ...
    public ChunkGeneratorSkyland(World par1World, long par2, int theme)
    {
