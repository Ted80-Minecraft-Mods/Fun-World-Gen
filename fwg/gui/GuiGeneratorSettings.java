...
public class GuiGeneratorSettings extends GuiScreen
{
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		//title
		String title = "Fun World Generator mod";
    	...
    	drawString(fontRendererObj, "Server config: ", width / 2 - 153, 155, 16777215);
    	drawString(fontRendererObj, "level-type=FWG", width / 2 - 153, 169, 10526880);
    	drawString(fontRendererObj, "generator-settings=" + createString(), width / 2 - 153, 179, 10526880);
	...
	public void createList()
	{
		...
		for(int g = 0; g < GeneratorType.generatortypes.length; g++)
		{
			...
			{
				generators.add(new GuiGeneratorButton(StatCollector.translateToLocal("fwg." + GeneratorType.generatortypes[g].GetName()), g, count + 10, 50 + (20 * count), width));
